...
class Dataset:
    ...
    def audio_processing(self, clean_filename):
        ...
        noisy_magnitude = np.stack((noisy_spectrogram.real,noisy_spectrogram.imag))
        # print('noisy shape:',noisy_magnitude.shape)
        ...
        clean_magnitude = np.stack((clean_spectrogram.real,clean_spectrogram.imag))
        # print('clean shape: ',clean_magnitude.shape)
...
if __name__ == '__main__':
    ...
    clean_basepath = cfg.CLEAN_BASEPATH
    noise_basepath = cfg.NOISY_BASEPATH
    ...
    clean_json_file = cfg.CLEAN_JSON_FILE
    noise_json_file = cfg.NOISE_JSON_FILE
    ...
    clean_target_base_path_for_saving = cfg.PREPROCESSED_CLEAN_TARGET
    noisy_input_base_path_for_saving = cfg.PREPROCESSED_NOISY_INPUT
    ...
    # generate_noisy_waveform_for_test_set(clean_json_file, noise_json_file, fs, saving_path_base)
